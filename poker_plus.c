...
/*=================================================*
 * main:calls read_cards,analyze_hand,print_result *
 *      repeatedly                                 *
 *=================================================*/
int main(void)
{
...
void read_cards(void)
{
    ...
    while(cards_read < NUM_CARDS){
        ...
        if(bad_cards){
            ...
            printf("Duplicate cards; ignored.\n");
        }else{
            num_in_rank[rank]++;
            num_in_suit[suit]++;
 ...
 *              of pairs; stores the results into external  *
 *              variables.                                  *
 *==========================================================*/
void analyze_hand(void)
{
...
/*============================================================*
 * print_result:Notifies the user of the result,using the     *
 *              external variables set by analyze_hand.       *
 *============================================================*/
